...
Mirror an existing client on the same family: `jurisdictions/us/co/adams.py` (ArcGIS
JSON driver), `platforms/spatialest.py` (Spatialest JSON), or `platforms/eagleweb.py` (scrape).
